...
pub const unit8 = u8;
pub const unit16 = c_ushort;
pub const unit32 = c_uint;
pub export fn ddp_uncompress(arg_uncompr: [*c]unit8, arg_uncomprlen: unit32, arg_compr: [*c]unit8, arg_comprlen: unit32) void {
    var uncompr = arg_uncompr;
    _ = &uncompr;
    var uncomprlen = arg_uncomprlen;
    _ = &uncomprlen;
    var compr = arg_compr;
    _ = &compr;
    var comprlen = arg_comprlen;
    _ = &comprlen;
    var curbyte: unit32 = 0;
    _ = &curbyte;
    var i: unit32 = undefined;
    _ = &i;
    var act_uncomprlen: unit32 = 0;
    _ = &act_uncomprlen;
    while (act_uncomprlen < uncomprlen) {
        var flag: unit8 = compr[
            blk: {
                const ref = &curbyte;
                const tmp = ref.*;
                ref.* +%= 1;
        ...
        _ = &flag;
        var offset: unit32 = undefined;
        _ = &offset;
        var copy_len: unit32 = undefined;
        _ = &copy_len;
        if (@as(c_int, flag) < @as(c_int, 29)) {
            copy_len = @bitCast(@as(c_int, @as(c_int, flag) + @as(c_int, 1)));
            offset = 0;
        } else if (@as(c_int, flag) == @as(c_int, 29)) {
            copy_len = @bitCast(@as(c_int, @as(c_int, compr[
                blk: {
                    const ref = &curbyte;
                    const tmp = ref.*;
                    ref.* +%= 1;
            ...
            offset = 0;
        } else if (@as(c_int, flag) == @as(c_int, 30)) {
            copy_len = @bitCast(@as(c_int, ((@as(c_int, compr[curbyte]) << @intCast(@as(c_int, 8))) | @as(c_int, compr[curbyte +% @as(unit32, 1)])) + @as(c_int, 286)));
            curbyte +%= 2;
            offset = 0;
        } else if (@as(c_int, flag) == @as(c_int, 31)) {
            copy_len = @bitCast(@as(c_int, (((@as(c_int, compr[curbyte]) << @intCast(@as(c_int, 24))) | (@as(c_int, compr[curbyte +% @as(unit32, 1)]) << @intCast(@as(c_int, 16)))) | (@as(c_int, compr[curbyte +% @as(unit32, 2)]) << @intCast(@as(c_int, 8)))) | @as(c_int, compr[curbyte +% @as(unit32, 3)])));
            curbyte +%= 4;
            offset = 0;
        } else {
            if (@as(c_int, flag) < @as(c_int, 128)) {
                if ((@as(c_int, flag) & @as(c_int, 96)) == @as(c_int, 32)) {
                    copy_len = @bitCast(@as(c_int, @as(c_int, flag) & @as(c_int, 3)));
                    offset = @bitCast(@as(c_int, (@as(c_int, flag) >> @intCast(@as(c_int, 2))) & @as(c_int, 7)));
                } else if ((@as(c_int, flag) & @as(c_int, 96)) == @as(c_int, 64)) {
                    copy_len = @bitCast(@as(c_int, (@as(c_int, flag) & @as(c_int, 31)) + @as(c_int, 4)));
                    offset = compr[
                        blk: {
                            const ref = &curbyte;
                            const tmp = ref.*;
                    ...
                    offset = @bitCast(@as(c_int, ((@as(c_int, flag) & @as(c_int, 31)) << @intCast(@as(c_int, 8))) | @as(c_int, compr[
                        blk: {
                            const ref = &curbyte;
                            const tmp = ref.*;
                            ref.* +%= 1;
                    ...
                    while (true) {
                        switch (@as(c_int, flag)) {
                            @as(c_int, 254) => {
                                copy_len = @bitCast(@as(c_int, ((@as(c_int, compr[curbyte]) << @intCast(@as(c_int, 8))) | @as(c_int, compr[curbyte +% @as(unit32, 1)])) + @as(c_int, 258)));
                                curbyte +%= 2;
                                break;
                            },
                            @as(c_int, 255) => {
                                ...
                                copy_len = @bitCast(@as(c_int, @as(c_int, flag) + @as(c_int, 4)));
                            },
                        }
                        break;
                    }
                ...
                copy_len = @bitCast(@as(c_int, (@as(c_int, flag) >> @intCast(@as(c_int, 5))) & @as(c_int, 3)));
                offset = @bitCast(@as(c_int, ((@as(c_int, flag) & @as(c_int, 31)) << @intCast(@as(c_int, 8))) | @as(c_int, compr[
                    blk: {
                        const ref = &curbyte;
                        const tmp = ref.*;
